...
// const cycling1 = new Cycling([30, 30], 27, 96, 500);
...
class App {
  ...
  _loadMap(position) {
    ...
    // console.log(this);
    this.#map = L.map('map').setView(coords, this.#moveZoomLevel);
  ...
  _newWorkout(e) {
    ...
    //Add new objecty to workout array
  ...
  _moveToPopup(e) {
    ...
    this.#map.setView(workout.coords, this.#moveZoomLevel, {
      animate: true,
      pan: {
        duration: 1,
      },
